...
## 5. Alamat Produksi (Live)
- **Frontend (GitHub Pages)**: [https://indriyatikoe80-ops.github.io/portal/](https://indriyatikoe80-ops.github.io/portal/)
- **Backend (Hugging Face Spaces)**: [https://candrabuwana80-my-backend-api.hf.space/](https://candrabuwana80-my-backend-api.hf.space/)
- **Database (Aiven)**: Dikelola via Aiven Console.
